...
# MSP 
# ============= #
# Discrete a Beta Function (1.5, 1.5)
beta_dist = Beta(1.5, 1.5)
...
savefig("reservation_wages_over_time_MSP.png")
...
savefig("value_functions_over_time_MSP.png")
...
plot!(w̄_vec_init, v_w̄_init, color=:red, lw=2)
...
savefig("value_functions_over_time_w_reservation_wage_MSP.png")
